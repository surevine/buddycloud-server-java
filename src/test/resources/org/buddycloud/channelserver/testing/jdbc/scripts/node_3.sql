...
INSERT INTO "items" ("thread_id", "node_id", "id", "updated", "xml") SELECT "thread_id", "nodes"."node_id", "item_id", "updated", '<entry xmlns="http://www.w3.org/2005/Atom" xmlns:activity="http://activitystrea.ms/spec/1.0/">
...
INSERT INTO "threads" ("item_id", "updated", "node_id") SELECT 'a1', TIMESTAMP '2010-01-06 21:41:32', "node_id" FROM "nodes" WHERE "node" = 'users/node3@server1/posts';
INSERT INTO "items" ("thread_id", "node_id", "id", "updated", "xml") SELECT "thread_id", "nodes"."node_id", "item_id", "updated", '<entry xmlns="http://www.w3.org/2005/Atom" xmlns:activity="http://activitystrea.ms/spec/1.0/">
             ...
             </entry>' FROM "nodes" JOIN "threads" ON "threads"."node_id" = "nodes"."node_id" WHERE "node"='users/node3@server1/posts' AND "item_id" = 'a1';
